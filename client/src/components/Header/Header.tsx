        ...
        <header>
            <nav className="navigation">
                ...
                <ul className={isActive ? "burger__active" : "navigation__list"}>
                    ...
                    <li className={isUserLoggedIn ? "navigation__list__item" : "hidden__element"}>
                        <NavLink
                            to={"/wishlist"}
                            className={({ isActive }) => (isActive ? "active" : undefined)}
                        >
                    ...
                    <li className={isUserLoggedIn ? "hidden__element" : "navigation__list__item"}>
                        <NavLink
                            to={"/login-signup"}
                            className={({ isActive }) => (isActive ? "active" : undefined)}
                        >
                    ...
                    <li className={isUserLoggedIn ? "navigation__list__basket" : "hidden__element"}>
                        <NavLink
                            to={"/my-profile"}
                            className={({ isActive }) => (isActive ? "active" : undefined)}
                        >
